...
class Girl:
    ...
    def __init__(self, x_pos, y_pos, pics):
        ...
        for i in range(3):
            right.append(image.load("Girl_Character/right/right" + str(i) + ".png"))
        for i in range(3):
            down.append(image.load("Girl_Character/down/down" + str(i) + ".png"))
        for i in range(3):
            up.append(image.load("Girl_Character/up/up" + str(i) + ".png"))
        for i in range(3):
            left.append(image.load("Girl_Character/left/left" + str(i) + ".png"))
